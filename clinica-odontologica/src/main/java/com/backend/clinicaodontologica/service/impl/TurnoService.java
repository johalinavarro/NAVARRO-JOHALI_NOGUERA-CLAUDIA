...
public class TurnoService implements ITurnoService {
    ...
    @Override
    public TurnoSalidaDto actualizarTurno(TurnoModificacionEntradaDto turnoModificacionEntradaDto) throws ResourceNotFoundException, BadRequestException {

        Turno turnoAModificar = turnoRepository.findById(turnoModificacionEntradaDto.getId()).orElse(null);
        TurnoSalidaDto turnoSalidaDto = new TurnoSalidaDto();
        if(turnoAModificar!=null){

            PacienteSalidaDto pacienteSalidaDto = pacienteService.buscarPacientePorId(turnoModificacionEntradaDto.getPacienteId());
            LOGGER.info("PacienteSalidaDto: {}", JsonPrinter.toString(pacienteSalidaDto));

            OdontologoSalidaDto odontologoSalidaDto = odontologoService.buscarOdontologoPorId(turnoModificacionEntradaDto.getOdontologoId());
            ...
            if(turnoModificacionEntradaDto.getFechaYHora() == null){
                throw new BadRequestException("No se ha especificado la fecha/hora del turno");
            }
            ...
            Turno turnoEntidad = new Turno();
            turnoEntidad.setId(turnoModificacionEntradaDto.getId());
            turnoEntidad.setPaciente(pacienteEntidad);
            turnoEntidad.setOdontologo(odontologoEntidad);
            turnoEntidad.setFechaYHora(turnoModificacionEntradaDto.getFechaYHora());
